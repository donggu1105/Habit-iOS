...
//    static let fullName = TextFieldOptionSet(rawValue: 1 << 0)
    static let memo = TextFieldOptionSet(rawValue: 1 << 0)
...
//    }
    ...
    class func memo(placeholderStyle: EKProperty.LabelStyle,
                        textStyle: EKProperty.LabelStyle,
                        separatorColor: EKColor,
                        style: FormStyle) -> EKProperty.TextFieldContent {
        let memoPlaceholder = EKProperty.LabelContent(
            text: "간단한 기록을 남겨보세요.",
            style: placeholderStyle
        )
        return .init(keyboardType: .namePhonePad,
                     ...
                     displayMode: .dark,
                     textStyle: textStyle,
//                     leadingImage: UIImage(named: "ic_success")!.withRenderingMode(.alwaysTemplate),
                     bottomBorderColor: separatorColor,
    ...
    class func fields(by set: TextFieldOptionSet,
        ...
        if set.contains(.memo) {
            array.append(memo(placeholderStyle: placeholderStyle,
                                  textStyle: textStyle,
